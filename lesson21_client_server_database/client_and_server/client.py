...
class Client:
    ...
    async def edit_post(
        ...
        return (await self._send_request(HTTPMethod.DELETE, url, data_1),
                await self._send_request(HTTPMethod.POST, url, data_2))
    ...
    async def edit_comment(
        ...
        url = self._server_url / "comment_edit"
        data_1 = {
            "user": user.to_dict(),
            "post_title": post_title,
            "post_description": post_description,
    ...
    async def delete_comment(
        ...
        url = self._server_url / "comment_delete"
        data = {
            "user": user.to_dict(),
            "post_title": post_title,
            "post_description": post_description,
    ...
    async def delete_like(
        ...
        url = self._server_url / "like_delete"
        data = {
            "user": user.to_dict(),
            "post_title": post_title,
            "post_description": post_description
